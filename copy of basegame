    ...
    while True:
        ...
        while True:
            ...
            if action == 'roll': 
                ...
                if dice_num == 1: 
                    turn_used_by_dice = roll_dice_one(board, player, opponent) 
                elif dice_num == 2: 
...
# post game menu...
        ...
        print("  ========================================================")
        print("  [C] CONTINUE TOURNAMENT: Your current wins and names")
        print("      will be saved and pass over onto the next round.")
        print("  [N] START NEW GAME: This will erase all current scores")
        print("      and let you enter new names for a fresh start.")
        print("  [Q] QUIT: Exit the game.")
        print("  ========================================================")

        again = ""
        while again not in ['c', 'n', 'q']:
            again = input("  Choose C, N, or Q: ").strip().lower()

        if again == "q":
            print("\n  Thanks for playing gang! Have a swagalicious day.\n")
            break
        elif again == "n":
            is_new_tournament = True # This triggers the name/score reset at the top of the loop
        elif again == "c":
            is_new_tournament = False # This skips the reset, preserving names and scores
